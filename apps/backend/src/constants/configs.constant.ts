...
export const FEATURE_FLAGS_L1_TTL_MS = 'FEATURE_FLAGS_L1_TTL_MS';
export const FEATURE_FLAGS_REDIS_TTL_SEC = 'FEATURE_FLAGS_REDIS_TTL_SEC';
export const FEATURE_FLAGS_REDIS_CHANNEL = 'FEATURE_FLAGS_REDIS_CHANNEL';
