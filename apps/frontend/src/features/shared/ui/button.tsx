  ...
  return (
    ...
    >
      <span
        ...
        className="inline-flex items-center justify-center gap-2 data-[loading=true]:opacity-0 transition-opacity whitespace-nowrap"
      >
        {children}
      </span>

      <Loader loading={loading} size="xs" />
    </Comp>
  );
}
